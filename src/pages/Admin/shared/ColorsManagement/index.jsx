...
const ColorsManagement = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${import.meta.env.VITE_API_URL}/v1/colors?pageNo=1&pageSize=10`, {
      method: "GET",
      headers: {
  ...
  const handleAddColor = () => {
    ...
    fetch(`${import.meta.env.VITE_API_URL}/v1/colors`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  const handleUpdateColor = () => {
    ...
    fetch(`${import.meta.env.VITE_API_URL}/v1/colors/${editingColorId}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
  ...
  const handleConfirmDelete = () => {
    ...
    fetch(`${import.meta.env.VITE_API_URL}/v1/colors/${selectedColorId}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,
      },
